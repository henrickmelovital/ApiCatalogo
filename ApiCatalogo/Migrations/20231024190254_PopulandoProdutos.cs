...
namespace ApiCatalogo.Migrations
{
    ...
    public partial class PopulandoProdutos : Migration
    {
        ...
        {
            migrationBuilder.Sql("Insert into CTL_Produto(Nome,Descricao,Preco,ImagemUrl,Estoque,DataCadastro,CategoriaId)" +
        ...
        {
            migrationBuilder.Sql("Delete from CTL_Produto");
        }
    }
}
